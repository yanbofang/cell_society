...
- User Interface:
	...
	2. Set up a variety of parameters such as the number of rows/columns, the percentage of different groups of cells in the grid, and the rate of the program updating the state of the cells. Errors will be reported to the user through pop-up window detailing the problem, for example if they enter a wrong type of input. Default values will be assigned for unmodified fields.
...
1. Primary responsibilities of each team member:
